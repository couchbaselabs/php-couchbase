...
STD_PHP_INI_ENTRY("couchbase.decoder.json_arrays",           "1",    PHP_INI_ALL, OnUpdateBool,       dec_json_array,      zend_couchbase_globals, couchbase_globals)
...
static void php_extname_init_globals(zend_couchbase_globals *couchbase_globals)
{
    ...
    couchbase_globals->dec_json_array = 1;
...
PHP_MINIT_FUNCTION(couchbase)
{
    ...
    PHP_MINIT(AnalyticsIndexManager)(INIT_FUNC_ARGS_PASSTHRU);
    ...
    PHP_MINIT(Metrics)(INIT_FUNC_ARGS_PASSTHRU);
    PHP_MINIT(Tracing)(INIT_FUNC_ARGS_PASSTHRU);
